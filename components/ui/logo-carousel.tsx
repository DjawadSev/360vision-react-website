...
export function LogoCarousel({ columns = 2 }: { columns?: number }) {
  ...
  const logos = useMemo<Logo[]>(
    () => [
      { id: 1, name: "Meta Ads", src: "/images/tools/meta-icon.png" },
      { id: 2, name: "Unreal Engine", src: "/images/tools/Unreal_Engine-Logo.wine.png", scale: 1.15 },
      { id: 3, name: "HubSpot", src: "/images/tools/hubspot-icon.png" },
      { id: 4, name: "TikTok Marketing", src: "/images/tools/1691751088logo-tiktok-png.png" },
      { id: 5, name: "React", src: "/images/tools/React-icon.svg.png", scale: 1.05 },
    ],
    []
  );
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Image
            ...
            style={{ transform: `scale(${currentLogo.scale ?? 1})` }}
          />
        </motion.div>
      </AnimatePresence>
    </motion.div>
