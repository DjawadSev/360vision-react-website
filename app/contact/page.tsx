    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <p className="mt-4 text-lg text-white/70">
          Share context on your business goals, team size, and timeline. We typically reply within one business day and can kick
          off discovery the same week.
        </p>
      ...
      <form className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-lg">
        <div>
          ...
          <input
            id="name"
            name="name"
            className="mt-2 w-full rounded-2xl border border-white/20 bg-slate-950/60 px-4 py-3 text-white"
